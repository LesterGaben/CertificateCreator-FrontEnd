...
@Component({
  selector: 'certificate-template-5',
  standalone: true,
  imports: [],
  templateUrl: './certificate-template-5.component.html',
  styleUrl: './certificate-template-5.component.scss'
})
export class CertificateTemplate5Component {
