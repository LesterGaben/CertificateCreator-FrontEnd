...
@Component({
  selector: 'certificate-template-6',
  standalone: true,
  imports: [],
  templateUrl: './certificate-template-6.component.html',
  styleUrl: './certificate-template-6.component.scss'
})
export class CertificateTemplate6Component {
